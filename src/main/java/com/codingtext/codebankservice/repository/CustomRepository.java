...
public interface CustomRepository {
    ...
    Page<Code> findCodesWithFilterAndSearch(List<String> algorithms, List<String> difficulties, String searchBy, String searchText, String sortBy, RegisterStatus registerStatus, Pageable pageable);
